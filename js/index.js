...
document.addEventListener("DOMContentLoaded", function () {
    const resizeMessage = document.createElement('div');
    resizeMessage.classList.add('resize-message');
    resizeMessage.innerText = 'View in desktop for the best experience!';
